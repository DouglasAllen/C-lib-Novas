 ...
 */
   ...
   const short int month = 6;
   const short int day = 8;
   const short int leap_secs = 35;
   const short int accuracy = 0;
   short int error = 0;
   short int de_num = 0;
   
   const double hour = 5.0;
   const double ut1_utc = -0.387845;
   
   const double latitude = 41.9475360;
   const double longitude = -88.7430640;
   const double height = 257.32;
